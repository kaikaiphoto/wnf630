...
export const ARTIST_INFO = {
  ...
  bioBrief: '万年芳，一级演奏员、音乐制作人。中国民族管弦乐学会理事、上海计算机音乐协会理事、上海音乐家协会会员。曾任上海民族乐团弦乐声部长。在乐团期间先后师从方志强、邹德荣老师。深耕民族音乐领域四十余载，其演奏音色饱满淳厚、情感深沉真挚，是当代二胡艺术的集大成者与创新引领者。',
  bioFull: [
    '万年芳，一级演奏员、音乐制作人。现任中国民族管弦乐学会理事、上海计算机音乐协会理事、上海音乐家协会会员。他自幼受传统民族音乐熏陶，以深厚的艺术底蕴和卓越才华，活跃在国乐演奏与音乐制作的前沿。',
    '他曾任上海民族乐团弦乐声部长。在乐团工作期间，万年芳先生先后师从著名琴家方志强老师与邹德荣老师，深得传统二胡琴学精髓。他的演奏音色饱满淳厚、情感深沉真挚，既能完美诠释传统二胡音乐的深邃与苍凉，又致力于拓展中国民族音乐的现代生命力。',
    '万先生不仅在传统演奏上臻于化境，作为杰出的音乐制作人，他极力推动计算机现代音乐、数字音频与民族乐器的跨界融合。他多次代表国家出访欧美及亚洲十几个国家与地区进行艺术交流，在二胡艺术的理论研究与新媒体传播中建树颇丰。'
  ],
  ...
  achievements: [
    ...
    { year: '1995', title: '被评为一级演奏员（正高级职称），享受国务院特殊津贴' },
